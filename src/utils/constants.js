...
const TEMPLATES = {
	...
	committeeLeader: {
		...
		type: 'TABLE',
		data: [
			{ label: '姓名', prop: 'memberName', width: 1505 },
			{ label: '岗位职务', prop: 'adminPost', width: 2000 },
			{ label: '入党时间', prop: 'joinDate', width: 2000 },
			{ label: '分工内容', prop: 'workDep', width: 5505 },
		],
		columnWidths: [1505, 2000, 2000, 5505],
	},
	// 党小组长名单
	groupLeader: {
		title: '党小组长名单',
	...
	memberGroup: {
		...
		type: 'TABLE',
		data: [
			{ label: '小组名称', prop: 'groupName', width: 5505 },
			{ label: '负责人', prop: 'leader', width: 3505 },
		],
	...
	formalMember: {
		...
		type: 'TABLE',
		data: [
			{ label: '党员姓名', prop: 'memberName', width: 605 },
			{ label: '性别', prop: 'sex', width: 300 },
			{ label: '出生年月', prop: 'birthday', width: 900 },
			{ label: '入党时间', prop: 'joinDate', width: 900 },
			{ label: '学历', prop: 'edu', width: 500 },
			{ label: '党内分工', prop: 'adminPost', width: 2005 },
			{ label: '所属党支部', prop: 'orgName', width: 1900 },
			{ label: '所属党小组', prop: 'groupName', width: 1900 },
		],
		columnWidths: [605, 300, 900, 900, 500, 2005, 1900, 1900],
	},
	// 党员调动记录
	memberTransfer: {
		title: '党员调动记录',
		type: 'TABLE',
		data: [
			{ label: '党员姓名', prop: 'memberName', width: 1505 },
			{ label: '由何处调出', prop: 'outOrgName', width: 3000 },
			{ label: '由何处调⼊', prop: 'inOrgName', width: 3000 },
			{ label: '调出⽇期', prop: 'outDate', width: 1505 },
			// { label: "调⼊⽇期", prop: "没有" },
		],
		columnWidths: [1505, 3000, 3000, 1505],
	},
	// 帮困记录
	help: {
		title: '帮困记录',
		type: 'TABLE',
		data: [
			{ label: '姓名', prop: 'helpName', width: 1505 },
			{ label: '性别', prop: 'sex', width: 1000 },
			{ label: '政治面貌', prop: 'zzmm', width: 1000 },
			{ label: '困难情况', prop: 'poorSitu', width: 5505 },
		],
		columnWidths: [1505, 1000, 1000, 5505],
	},
	// 谈心谈话
	talk: {
		title: '谈心谈话',
		...
		data: [
			...
			{ label: '性别', prop: 'sex', width: 1000 },
			{ label: '政治面貌', prop: 'zzmm', width: 1000 },
			{ label: '谈话时间', prop: 'talkTime', width: 1000 },
			{ label: '困难情况', prop: 'poorSitu', width: 4505 },
		],
		columnWidths: [1505, 1000, 1000, 1000, 4505],
	},
	// 发展党员
	developMember: {
		title: '发展党员',
		type: 'TABLE',
		data: [
			{ label: '党员姓名', prop: 'memberName', type: 'text', width: 1405 },
			{ label: '所属党⽀部', prop: 'orgName', type: 'text', width: 2500 },
			{ label: '所属党⼩组', prop: 'groupName', type: 'text', width: 2500 },
			{ label: '出⽣⽇期', prop: 'birthday', type: 'text', width: 1300 },
			{ label: '⼈员阶段', prop: 'status', type: 'text', width: 1305 },
		],
		columnWidths: [1405, 2500, 2500, 1300, 1305],
	},
	// 党支部大会记录
	branch: {
		title: '党支部大会记录',
	...
	brach: {
		...
		type: 'TABLE',
		data: [
			{ label: '⽇期', prop: 'actualDate', type: 'text', width: 1005 },
			{
				label: '出席⼈员（签名）',
				prop: 'attenders',
				type: 'text',
			...
			{ label: '会议主要议题', prop: 'detail', type: 'text', width: 7000 },
		],
	...
	partyDuesSummary: {
		...
		type: 'TABLE',
		data: [
			{ label: '党组织', prop: 'name', width: 2510 },
			{ label: '1月', prop: '01', width: 500 },
			{ label: '2月', prop: '02', width: 500 },
			{ label: '3月', prop: '03', width: 500 },
			{ label: '4月', prop: '04', width: 500 },
			{ label: '5月', prop: '05', width: 500 },
			{ label: '6月', prop: '06', width: 500 },
			{ label: '7月', prop: '07', width: 500 },
			{ label: '8月', prop: '08', width: 500 },
			{ label: '9月', prop: '09', width: 500 },
			{ label: '10月', prop: '10', width: 500 },
			{ label: '11月', prop: '11', width: 500 },
			{ label: '12月', prop: '12', width: 500 },
			{ label: '小计', prop: 'summary', width: 500 },
		],
	},
	// 党员民主评议管理
	deliberation: {
...
/**
 * @description: docx预览配置
 */
export const previewOpt = {
