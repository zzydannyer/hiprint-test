...
export const TEMPLATES = {
  ...
  党支部大会记录: (data) => ({
    ...
    tbody: [
      ...
      [
        ...
        { key: "orgName", content: "", width: 100, editable: true },
      ...
      [
        ...
        { key: "orgName", content: "无备注", colspan: 3, editable: true },
      ],
    ],
  }),
  党支委会会议: () => ({
  ...
  支部年度工作计划: (data) => ({
    ...
    tbody: [
      ...
      [
        ...
        { key: "orgName", content: "", editable: true },
      ],
      [
        {
          title: "会议记录：",
  ...
  民主生活会: (data) => ({
    ...
    tbody: [
      ...
      [
        { key: "label", content: "备注", width: 64, editable: false },
        { key: "orgName", content: "无备注", colspan: 4, editable: true },
      ],
    ],
  }),
  党员民主评议管理: (data) => ({
