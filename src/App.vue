<template>
	<div id="app">
		...
		<el-button type="default" @click="handlePrintDialog">弹窗</el-button>
      ...
      <el-button type="primary" size="mini" @click="printByPrintThis">
		...
		>
			...
			>
				...
				/>
				<el-button type="default" size="mini" @click="printByPrintPartial"
					>打印</el-button
				>
				<el-button type="primary" size="mini" @click="exportDOCX"
					>导出docx</el-button
				>
			</div>
			<div
	...
	methods: {
		...
		async handlePrintDialog() {
			try {
				...
				this.visible = true
				await this.$nextTick()
				this.docxDocument = new DocumentCreator({})
				await this.docxDocument.create()
				await this.docxDocument.preview()
				this.adjustSize()
			} catch (error) {
		...
		// async docxCore() {
		// 	this.docxDocument = new DocumentCreator({})
		// 	return this.docxDocument.create()
		// },
		printByPrintPartial() {
